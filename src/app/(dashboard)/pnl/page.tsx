...
import { mockPnL } from "@/lib/mock-data";
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base font-semibold">
              Profit & Loss Statement — {pnl.period}
            </CardTitle>
          </CardHeader>
          <CardContent className="max-w-2xl">
            <div className="space-y-1">
              ...
              {pnl.revenue.shopify > 0 && (
                <PnLRow
                  label="Shopify Sales"
                  value={pnl.revenue.shopify}
                  indent
                  color={CHANNEL_CONFIG.shopify.color}
                />
              )}
              {pnl.revenue.amazon > 0 && (
                <PnLRow
                  label="Amazon Sales"
                  value={pnl.revenue.amazon}
                  indent
                  color={CHANNEL_CONFIG.amazon.color}
                />
              )}
              ...
              <PnLRow
                ...
                value={pnl.fees.marketplace}
                indent
                negative
              />
              <PnLRow
                label="Shipping Costs"
                value={pnl.fees.shipping}
                indent
                negative
              />
              <PnLRow
                label="Payment Processing"
                value={pnl.fees.processing}
                indent
                negative
              />
              <PnLRow
                label="Advertising"
                value={pnl.fees.advertising}
                indent
                negative
              />
              <PnLRow
                label="Returns & Refunds"
                value={pnl.fees.refunds}
                indent
                negative
              />
              <Separator className="my-2" />
