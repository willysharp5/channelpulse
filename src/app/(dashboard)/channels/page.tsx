...
import { mockChannels, mockChannelRevenue } from "@/lib/mock-data";
      ...
      <div className="flex-1 space-y-6 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {mockChannels.map((channel) => {
            const config = CHANNEL_CONFIG[channel.platform];
            const revenue =
              mockChannelRevenue.find((r) => r.channel === channel.platform)
                ?.revenue ?? 0;
              ...
              <Card key={channel.id} className="relative overflow-hidden">
                ...
                <CardContent>
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      <p className="text-lg font-bold tabular-nums">
                        {formatCurrency(revenue / channel.ordersCount)}
                      </p>
                  ...
                  <div className="mt-4 flex items-center justify-between border-t pt-3">
                    <span className="flex items-center gap-1.5 text-xs text-muted-foreground">
                      ...
                      Last synced {channel.lastSyncAt ? formatRelativeDate(channel.lastSyncAt) : "never"}
                    </span>
